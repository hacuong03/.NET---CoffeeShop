...
namespace BTL_CoffeeShop.Class
{
    internal class Functions
    {
        ...
        public static void Connect()
        {
            ...
            connString = @"Server=NGUYENHAIXON\MSSQLSERVER2,1433;Database=QuanLyQuanCafe;Trusted_Connection=True";
        ...
        public static bool IsDate(string d)
        {
            ...
            if ((Convert.ToInt32(parts[0]) >= 1) && (Convert.ToInt32(parts[0]) <= 31) &&
                (Convert.ToInt32(parts[1]) >= 1) && (Convert.ToInt32(parts[1]) <= 12) && (Convert.ToInt32(parts[2]) >= 1400))
                return true;
            else
                return false;
        }
